...
| `sales-demos-dev-workflow` | The end-to-end dev/test cycle — branch, PR, merge, `config.yml`, Linux Day 1 - 0 Workflow |
...
`rhel9` populated ([#3](https://github.com/ericcames/sales.demos/issues/3)). Building and publishing the image is [image.builder.pipeline#24](https://github.com/ericcames/image.builder.pipeline/issues/24);
