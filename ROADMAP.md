...
| 4 | AAP Lightspeed on the self-hosted Granite endpoint. Chatbot config Secret + AAP CR patch, gated by `-e serve_model_enable_lightspeed=true`. Teardown disables it. | **In progress** ([#704](https://github.com/ericcames/sales.demos/issues/704)) |
